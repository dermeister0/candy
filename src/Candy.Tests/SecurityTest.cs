...
namespace Candy.Tests
{
    ...
    public class SecurityTest
    {
        ...
        {
            Assert.That(
                SecurityUtils.MD5("mypassword"), Is.EqualTo("34819d7beeabb9260a5c854bc85b3e44".ToUpper()));
            Assert.That(
                SecurityUtils.Sha1("mypassword"), Is.EqualTo("91dfd9ddb4198affc5c194cd8ce6d338fde470e2".ToUpper()));
            Assert.That(
